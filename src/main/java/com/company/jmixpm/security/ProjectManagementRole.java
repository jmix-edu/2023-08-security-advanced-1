...
public interface ProjectManagementRole {
    ...
    @ScreenPolicy(screenIds = {"User.browse", "Project.browse", "Task_.browse", "Document.browse", "Document.edit", "Project.edit", "Task_.edit", "User.edit", "MyNotifications", "TimeEntry.browse", "TimeEntry.edit", "QuickAddTimeEntry"})
    void screens();
